...
from api_core.routes.crypto import router as crypto_router
from api_core.routes.fx import router as fx_router
from api_core.routes.bonds import router as bonds_router
