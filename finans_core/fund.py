...
from finans_core._providers.tefas import get_tefas_provider
from finans_core.exceptions import DataNotAvailableError
from finans_core.technical import TechnicalMixin
from finans_core.twitter import TwitterMixin, _build_fund_query
...
class Fund(TechnicalMixin, TwitterMixin):
    ...
    def tax_category(self) -> str | None:
        ...
        """
        from finans_core.tax import classify_fund_tax_category
    ...
    def withholding_tax_rate(
        ...
        from finans_core.tax import get_withholding_tax_rate
    ...
    def risk_metrics(
        ...
        if risk_free_rate is None:
            try:
                from finans_core.bond import risk_free_rate as get_rf_rate
    ...
    def get_holdings(
        ...
        """
        from finans_core._providers.kap_holdings import get_kap_holdings_provider
