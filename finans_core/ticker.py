...
from finans_core._providers.kap import get_kap_provider
from finans_core._providers.tradingview import get_tradingview_provider
from finans_core.technical import TechnicalMixin
from finans_core.twitter import TwitterMixin, _build_stock_query
...
class Ticker(TechnicalMixin, TwitterMixin):
    ...
    def _get_isyatirim(self):
        ...
        if self._isyatirim is None:
            from finans_core._providers.isyatirim import get_isyatirim_provider
    ...
    def _get_isin_provider(self):
        ...
        if self._isin_provider is None:
            from finans_core._providers.isin import get_isin_provider
    ...
    def _get_hedeffiyat(self):
        ...
        if self._hedeffiyat is None:
            from finans_core._providers.hedeffiyat import get_hedeffiyat_provider
    ...
    def _get_etf_provider(self):
        ...
        if self._etf_provider is None:
            from finans_core._providers.tradingview_etf import get_tradingview_etf_provider
