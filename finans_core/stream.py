...
from finans_core._providers.tradingview import get_tradingview_auth
...
class StudySession:
    ...
    def _get_pine_facade(self):
        ...
        if self._pine_facade is None:
            from finans_core._providers.pine_facade import get_pine_facade_provider
    ...
    def _normalize_indicator(self, indicator: str) -> tuple[str, str]:
        ...
        """
        from finans_core._providers.pine_facade import STANDARD_INDICATORS
    ...
    def _parse_study_values(
        ...
        Returns:
            Parsed values dict
        """
        from finans_core._providers.pine_facade import INDICATOR_OUTPUTS
