...
from finans_core._providers.evds import (
    AGGREGATION,
    FORMULA,
    FREQUENCY,
...
from finans_core.exceptions import APIError, DataNotAvailableError
...
def _resolve_window(
    ...
    if start is not None or end is not None:
        from finans_core._providers.evds import _format_date  # local import keeps surface tidy
        if start is None:
            start = "1950-01-01"
        if end is None:
